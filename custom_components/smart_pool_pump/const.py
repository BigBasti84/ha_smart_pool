...
CONF_PUMP_FLOW_FACTOR_MEDIUM = "pump_flow_factor_medium"
CONF_PUMP_FLOW_FACTOR_LOW = "pump_flow_factor_low"
...
DEFAULT_PUMP_FLOW_FACTOR_MEDIUM: float = 0.50
DEFAULT_PUMP_FLOW_FACTOR_LOW: float = 0.25
